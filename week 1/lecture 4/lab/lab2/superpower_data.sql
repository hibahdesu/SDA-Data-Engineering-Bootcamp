...
DROP TABLE IF EXISTS superhero.superhero_info;

CREATE TABLE superhero.superhero_info (
  id INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO superhero.superhero_info (id, superhero_name, full_name, gender_id, eye_colour_id, hair_colour_id, skin_colour_id, race_id, publisher_id, alignment_id, height_cm, weight_kg) VALUES
...
CREATE TABLE superhero.hero_power (
  ...
  CONSTRAINT fk_hpo_hero FOREIGN KEY (hero_id) REFERENCES superhero.superhero_info (id),
